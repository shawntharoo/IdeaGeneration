...
<body>
  ...
  <div class="container">
      ...
      <li class="active"><a href="#">Faculty of Computing</a></li>
      <li><a href="view_2.php">Faculty of Engineering</a></li>
      <li><a href="view_3.php">Faculty of Business Management</a></li> 
      
    </ul>
  </div>
</nav>  
  <ul class="nav nav-tabs">
    <li ><a data-toggle="tab" href="#menu1"><i class="fa fa-book"> ACADEMIC</i> </a></li>
    <li><a data-toggle="tab" href="#menu2"><i class="fa fa-phone"> NON-ACADEMIC </i></a></li>
    <li><a data-toggle="tab" href="#menu3"><i class="fa fa-trophy"> SPORTS</i> </a></li>
    <li><a data-toggle="tab" href="#menu4"><i class="fa fa-server"> SERVICES </i></a></li>
     <li><a data-toggle="tab" href="#menu5"><i class="fa fa-plus"> OTHERS </i></a></li>
  </ul>
    ...
    <div id="menu3" class="tab-pane fade">
     ...
     <?php
	 	if(isset($_POST["searchkey"])){
			$s= $_POST["searchkey"];
			$where = "WHERE  category='Sports and Societies' and faculty='Faculty of Computing' and title like '%$s%' OR content like '%$s%'";
		}else{
